...
{
    [InitializeOnLoad]
    internal static class SherpaONNXKwsDependencyGuidance
    {
        ...
        private const string SessionIgnoreKey = "EasyMic.SherpaONNX.KWS.DependencyReminder.SessionIgnored";
        private const string LogPrefix = "[EasyMic KWS Sample]";

        static SherpaONNXKwsDependencyGuidance()
        {
        ...
        private static void CheckDependencyAndPrompt()
        {
            ...
            int action = EditorUtility.DisplayDialogComplex(
                "SherpaONNX KWS Example Dependency Missing",
                "This sample requires com.eitan.sherpa-onnx-unity.\n\n" +
                "Install it to enable KWS components and scripts.",
