...
//             int remainder = toCopy % channels;
//             if (remainder != 0)
//             {
//                 int aligned = toCopy - remainder;
//                 if (aligned <= 0)
//                 {
//                     if (markEndOfStream)
//                     {
...
//                     return;
//                 }
//                 Debug.LogWarning($"EasyMic: Dropping {remainder} trailing samples to preserve frame alignment ({channels} channels).");
//                 toCopy = aligned;
//             }
